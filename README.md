...
| `SteamWeeklyCharts-HideIgnored.js` | Steam 畅销榜 | 隐藏或置灰并标记已标记为“不感兴趣”的游戏 |
...
Steam 脚本需要登录 Steam，才能读取当前账号的忽略列表。页面右上角的“已忽略游戏显示”开关可在“直接隐藏”和“置灰并标记”两种方式间切换，选择会保存在当前浏览器中。
